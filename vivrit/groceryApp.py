...
if db_conn != None:
		...
		for obj in billobjarr:
				...
				salesMgr.additem(db_conn,obj.itemname,strmrp,str(obj.disc),str(obj.qty),billprice,datevar,billName)
		...
		#get the remaining stocks inventory
		stock.printEntriesInDB(db_conn)
		#get stocks sold
		stock.printItemsSold(db_conn)
		#get the stock list
